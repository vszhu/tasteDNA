...
After the merge, Vercel's GitHub status for `4516ba0` reported **“Deployment was blocked.”** The detailed cause was not available without project access. The local build passed; the merged changes were not verified live. Check the current deployment status before resuming the account test.
