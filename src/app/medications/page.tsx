...
export default function MedicationsPage() {
  ...
  return <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-7 lg:px-8">
    ...
    {example && <section aria-label="Example medications" className="mb-4 flex flex-wrap items-center gap-3 rounded-2xl border border-[#dfcfaa] bg-[#f0e7d4] p-3 sm:px-4">
      <div className="mr-auto"><p className="text-[9px] font-bold tracking-[.1em] text-[#796036]">EXAMPLE LAB · NOT YOUR LIST</p><p className="mt-1 text-[11px] text-[#796b55]">Toggle to redraw connections.</p></div>
      <div className="flex flex-wrap gap-2">{MEDICATION_CATALOG.map((entry) => {
    ...
    <div className="mt-6 grid gap-4 text-[11px] leading-6 text-[var(--muted)] sm:grid-cols-[1fr_1.8fr]">
      <p className="flex items-start gap-2"><LockKeyhole className="mt-1 size-3.5 shrink-0" /><span>Your medication list stays in this browser tab. It is not sent to AI or shared with your dining group.</span></p>
