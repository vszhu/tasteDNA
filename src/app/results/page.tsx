...
export default function ResultsPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-9 sm:px-6 sm:py-14 lg:px-8">
      ...
      {updateMessage && <div className="mt-6 flex items-center gap-3 rounded-2xl bg-[#e5efe7] p-4 text-sm font-semibold text-[#315e4b]"><CheckCircle2 className="size-4" /> {updateMessage}</div>}
