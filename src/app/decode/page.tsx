  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
      ...
      <form onSubmit={submit} className="mx-auto mt-7 max-w-3xl">
        ...
        <div className="mt-5 flex flex-col gap-3 sm:flex-row"><Button type="submit" disabled={!hydrated} size="lg" variant="accent" className="flex-1">Decode this menu <ArrowRight className="size-4" /></Button><Button type="button" disabled={!hydrated} size="lg" variant="outline" onClick={() => { setExtractedMenu(createMedicationDemoMenu()); router.push("/results"); }}>Use sample menu</Button></div>
